...
import { MdOutlineAdd } from 'react-icons/md'; // Menggunakan ikon plus dari Material Design  
        ...
        <div id="sidebar" className="flex min-h-screen w-[360px] flex-col bg-white p-10 shadow-lg">  
            ...
            <div id="sidebar-menu" className="mt-10">  
                <ul id="menu-list" className="space-y-3">  
                    <li>  
                        <div id="menu-1" className="flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:text-hijau hover:bg-green-200 hover:font-extrabold">  
                            <MdDashboard className="mr-4 text-xl" />  
                            <span>Dashboard</span>  
                        </div>  
                    </li>  
                    <li>  
                        <div id="menu-2" className="flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:text-hijau hover:bg-green-200 hover:font-extrabold">  
                            <AiOutlineShoppingCart className="mr-4 text-xl" />  
                            <span>Orders</span>  
                        </div>  
                    </li>  
                    <li>  
                        <div id="menu-3" className="flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:text-hijau hover:bg-green-200 hover:font-extrabold">  
                ...
                <div id="footer-card" className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center">  
                    <div id="footer-text" className="text-white text-sm">  
                        ...
                        <div id="add-menu-button" className="flex justify-center items-center p-2 mt-3 bg-white rounded-md space-x-2">  
                            <MdOutlineAdd className="mr-4 text-xl" />  
